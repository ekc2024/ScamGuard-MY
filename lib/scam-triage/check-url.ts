...
import type { UrlCheck, UrlRisk } from "./types";

/** Brands most often imitated in Malaysian scam messages, with their real domains. */
const PROTECTED_BRANDS: { brand: string; tokens: string[]; officialDomains: string[] }[] = [
...
function isOfficialDomain(domain: string, officialDomains: string[]): boolean {
