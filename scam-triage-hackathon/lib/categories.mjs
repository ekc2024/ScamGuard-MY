 ...
 *
 * `coverage: "full"` categories were tuned against the TAR UMT Scam Ready
 * Movers survey responses (18-20 Aug 2026) and are demo-ready. `"partial"`
 * categories are detected but deliberately capped at medium confidence.
 */
...
export const CATEGORY_BY_ID = Object.fromEntries(
  CATEGORY_DEFINITIONS.map((definition) => [definition.category, definition])
);
